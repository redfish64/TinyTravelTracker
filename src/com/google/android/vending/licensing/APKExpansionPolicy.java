...
public class APKExpansionPolicy implements Policy {
    ...
    private void setValidityTimestamp(String validityTimestamp) {
        ...
        try {
            ...
            Log.w(TAG, /* ttt_installer:obfuscate_str */"License validity timestamp (VT) missing, caching for a minute");
    ...
    private void setRetryUntil(String retryUntil) {
        ...
        try {
            ...
            Log.w(TAG, /* ttt_installer:obfuscate_str */"License retry timestamp (GT) missing, grace period disabled");
            retryUntil = "0";
            lRetryUntil = 0l;
        }
    ...
    private void setMaxRetries(String maxRetries) {
        ...
        try {
            ...
            // No response or not parseable, expire immediately
            Log.w(TAG, /* ttt_installer:obfuscate_str */"Licence retry count (GR) missing, grace period disabled");
            maxRetries = "0";
            lMaxRetries = 0l;
        }
    ...
    private Map<String, String> decodeExtras(String extras) {
        ...
        try {
            ...
            Log.w(TAG, /* ttt_installer:obfuscate_str */"Invalid syntax error while decoding extras data from server.");
        }
        return results;
    }
