...
public class FileDialog extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (file.isDirectory()) {
			...
			//TODO 4 this is kind of a hack. I can't get selectors to work with these items for some reason,
			//and setSelected() makes the text turn dark gray which is really weird. So I just do it manually
			//like this
			if(selectedView != null)
			{
				selectedView.setBackgroundColor(getResources().getColor(android.R.color.black));
			}
