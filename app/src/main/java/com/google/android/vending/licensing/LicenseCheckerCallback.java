...
public interface LicenseCheckerCallback {
     ...
     * @param rawData the actual response, including signature. May be null if
     *  the policy decided we don't need to ask the market server
     */
     ...
     * @param rawData 
     */
    public void dontAllow(int reason, ResponseData rawData);
