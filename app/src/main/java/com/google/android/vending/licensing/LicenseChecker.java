...
public class LicenseChecker implements ServiceConnection {
    ...
    private static PublicKey generatePublicKey(String encodedPublicKey) {
        try {
            ...
            Log.e(TAG, /* ttt_installer:obfuscate_str */"Could not decode from Base64.");
            throw new IllegalArgumentException(e);
        } catch (InvalidKeySpecException e) {
            Log.e(TAG, /* ttt_installer:obfuscate_str */"Invalid key specification.");
            throw new IllegalArgumentException(e);
        }
    }
    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (mPolicy.allowAccess()) {
        	/* ttt_installer:remove_line */Log.i(TAG, "Using cached license response");
            callback.allow(Policy.LICENSED, null);
        } else {
            LicenseValidator validator = new LicenseValidator(mPolicy, new NullDeviceLimiter(),
                    callback, generateNonce(), mPackageName, mVersionCode);

            if (mService == null) {
            	/* ttt_installer:remove_line */Log.i(TAG, "Binding to licensing service.");
                try {
                    boolean bindResult = mContext
                            .bindService(
                                    new Intent(
                                    		/* ttt_installer:obfuscate_str */"com.android.vending.licensing.ILicensingService"),
                    ...
                    if (bindResult) {
                        ...
                        Log.e(TAG, /* ttt_installer:obfuscate_str */"Could not bind to service.");
    ...
    private void runChecks() {
        ...
        while ((validator = mPendingChecks.poll()) != null) {
            try {
            	/* ttt_installer:remove_line */Log.i(TAG, "Calling checkLicense on service for " + validator.getPackageName());
                ...
                Log.w(TAG, /* ttt_installer:obfuscate_str */"RemoteException in checkLicense call.", e);
                handleServiceConnectionError(validator);
            }
        }
    }
    ...
    private class ResultListener extends ILicenseResultListener.Stub {
        ...
        public ResultListener(LicenseValidator validator) {
            ...
            mOnTimeout = new Runnable() {
                public void run() {
                    Log.i(TAG, /* ttt_installer:obfuscate_str */"Check timed out.");
        ...
        public void verifyLicense(final int responseCode, final String signedData,
            ...
            mHandler.post(new Runnable() {
                public void run() {
                	...
                	/* ttt_installer:remove_line */Log.i(TAG, "Received response.");
                    // Make sure it hasn't already timed out.
                    
                    //note that signedData is null if there is no google play account
                    if (mChecksInProgress.contains(mValidator) && signedData != null) {
                        clearTimeout();
                    ...
                    if (DEBUG_LICENSE_ERROR) {
                        ...
                        if (logResponse) {
                            String android_id = Secure.getString(mContext.getContentResolver(),
                                    Secure.ANDROID_ID);
                            Date date = new Date();
                            Log.d(TAG, /* ttt_installer:obfuscate_str */"Server Failure: " + stringError);
                            Log.d(TAG, /* ttt_installer:obfuscate_str */"Android ID: " + android_id);
                            Log.d(TAG, /* ttt_installer:obfuscate_str */"Time: " + date.toGMTString());
                        }
                    }
        ...
        private void startTimeout() {
        	/* ttt_installer:remove_line */Log.i(TAG, "Start monitoring timeout.");
            mHandler.postDelayed(mOnTimeout, TIMEOUT_MS);
        }

        private void clearTimeout() {
        	/* ttt_installer:remove_line */Log.i(TAG, "Clearing timeout.");
    ...
    public synchronized void onServiceDisconnected(ComponentName name) {
        ...
        Log.w(TAG, /* ttt_installer:obfuscate_str */"Service unexpectedly disconnected.");
        mService = null;
    }
    ...
    private synchronized void handleServiceConnectionError(LicenseValidator validator) {
        ...
        if (mPolicy.allowAccess()) {
            validator.getCallback().allow(Policy.RETRY, null);
        } else {
            validator.getCallback().dontAllow(Policy.RETRY, null);
        }
    }
    ...
    private void cleanupService() {
        if (mService != null) {
            try {
                ...
                // error.
                Log.e(TAG, /* ttt_installer:obfuscate_str */"Unable to unbind from licensing service (already unbound)");
            }
            mService = null;
        }
    }
    ...
    private static String getVersionCode(Context context, String packageName) {
        try {
            ...
            Log.e(TAG, /* ttt_installer:obfuscate_str */"Package not found. could not get version code.");
            return "";
        }
    }
}
